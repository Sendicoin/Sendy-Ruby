...
describe Sendy::Transaction do
  before do
    ...
    stub_request(:get, "http://localhost:3000/v1/transactions/1")
      .with(
        headers: {
          'Authorization'=>'token valid_api_token',
        })
  ...
  it "is listable" do
    ...
    assert_requested :get, "#{Sendy.app_host}/v1/transactions"
  ...
  it "is retrievable" do
    ...
    assert_requested :get, "#{Sendy.app_host}/v1/transactions/1"
  ...
  it "is not creatable" do
    ...
    assert_not_requested :post, "#{Sendy.app_host}/v1/transactions"
  end
